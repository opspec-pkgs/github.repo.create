[![build](https://github.com/opspec-pkgs/github.repo.create/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/github.repo.create/actions/workflows/build.yml)
